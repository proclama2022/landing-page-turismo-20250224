...
export default function FinalStep({ formData, updateFormData, score }: FinalStepProps) {
  ...
  const getDiscoveryChannelText = (channel: string | undefined) => {
    if (!channel) {
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700">
                  Il tuo investimento di {formatCurrency(investmentAmount)} supera la soglia di €375.000 per cui è possibile ottenere il contributo massimo di €300.000 in regime de minimis. 
                ...
                <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-md">
                  <p className="text-sm text-blue-700">
                    <strong>Nota:</strong> Per progetti di questa entità, offriamo consulenza personalizzata per ottimizzare la struttura del finanziamento e massimizzare i benefici.
                  </p>
                </div>
              </div>
            </div>
